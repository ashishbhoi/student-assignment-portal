...
namespace StudentClassworkPortal.Areas.Identity.Pages.Account.Manage;
...
public class IndexModel : PageModel
{
    ...
    public async Task<IActionResult> OnPostAsync()
    {
        ...
        if (IsStudent)
        {
            if (Input.Class != user.Class) user.Class = Input.Class;

            if (Input.Section != user.Section) user.Section = Input.Section;
        }
